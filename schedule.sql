CREATE TABLE users(
                      ...
                      created_at DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '등록일', -- 초기 생성 시, 설정 후 변하지 않음
                      updated_at DATETIME COMMENT '수정일' -- 일정 최근 수정일에 따라 업데이트 될 변수
);
...
CREATE TABLE  tasks(
                       ...
                       updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '작성/수정일', -- UPDATE 마다 자동으로 시간 갱신됨
